...
{{/* Define unique labels for each microservice */}}
{{- define "microservices.reactLabel" -}}
app: {{ include "microservices.name" . }}{{ .Values.react.name }}
{{- end }}

{{- define "microservices.pythonLabel" -}}
app: {{ include "microservices.name" . }}{{ .Values.python.name }}
{{- end }}